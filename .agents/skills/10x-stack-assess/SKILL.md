...
- **Partial pass**: minimal framework BUT the project has documented conventions in instruction files (the project's AI configuration file (AGENTS.md)) or a visible conventions document. Score as pass-with-note.
