...
| the project's AI configuration file (AGENTS.md) / `AGENTS.md` | Agent instruction files | Category B — covered in agent onboarding |
...
- If stack-assess identified compensation strategies → check whether the recommended instruction-file entries exist (is the project's AI configuration file (AGENTS.md) / `AGENTS.md` present? Does it contain the recommended rules?)
...
- **Missing agent instruction files** (the project's AI configuration file (AGENTS.md) / `AGENTS.md`) → covered in the agent onboarding lesson. Do not recommend creating them now: "Agent onboarding walks you through building these with the right content. Generating a stub now would be premature."
