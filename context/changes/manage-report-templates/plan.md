...
- [x] 2.4 Verify independent persisted edits and access boundaries — fcbee2b
- [x] 2.5 Verify validation, mobile usability, and token guidance — fcbee2b
...
- [x] 3.4 Local-Supabase production-preview smoke scenario passes — d6ea111

#### Manual

- [x] 3.5 Verify local-only smoke credentials are not printed — d6ea111
